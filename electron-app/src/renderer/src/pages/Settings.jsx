...
const Settings = ({ clientId: propsClientId, clientSecret: propsClientSecret }) => {
  ...
  const _setClientId = (ev) => {
    if (ev?.currentTarget?.value) setClientId(ev.currentTarget.value)
  }

  const _setClientSecret = (ev) => {
    if (ev?.currentTarget?.value) setClientSecret(ev.currentTarget.value)
  }
  ...
  const saveApiKeySettings = () => {
    saveSettings(apiKeySettings, { clientId, clientSecret })
  }
