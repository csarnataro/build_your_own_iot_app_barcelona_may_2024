...
HUMIDITY_CHECK_DELAY_SECONDS = 2
DRY_LEVEL = 59000
WET_LEVEL = 20000
LED_ON = 0
LED_OFF = 1
...
def arduino_client_start():
    ...
    client.register("humidity", value=0.0)

    client.register(Task("loop", on_run=loop, interval=HUMIDITY_CHECK_DELAY_SECONDS))
...
def loop(client):  
    ...
    if is_connected_to_cloud:
      ...
      sleep_ms(50)  # allow power to settle
